    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-end justify-between gap-3">
        <div className="min-w-0">
          ...
          <h1 className="mt-1 truncate text-[21px] font-semibold text-[#16233f] sm:text-[26px]">Kelola Guru</h1>
      ...
      <div className="grid grid-cols-2 gap-2.5 sm:gap-4">
        <StatCard label="Total Guru" value={stats ? stats.totalGuru : "–"} icon={<IconUsers />} tone="violet" />
        <StatCard
      ...
      <Card className="overflow-hidden">
        {errorMessage ? (
          ...
          <div className="flex flex-col items-center gap-3 px-6 py-16 text-center">
            ...
            <p className="text-[13px] text-[#8b93a6]">Memuat data guru...</p>
          </div>
        ) : items.length === 0 ? (
          <div className="flex flex-col items-center gap-3 px-6 py-16 text-center">
          ...
          <>
            <div className="overflow-x-auto">
              <table className="w-full min-w-[640px] border-collapse text-left">
                ...
                <tbody>
                  {items.map((guru) => (
                    <tr key={guru.id} className="border-b border-[#f0f2f1] last:border-0 hover:bg-[#f7f9f8]">
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-2.5">
                          ...
                          <span className="truncate text-[13px] font-medium text-[#16233f]">{guru.nama}</span>
                        </div>
                      </td>
                      <td className="px-5 py-3.5 text-[12.5px] text-[#5b657d]">{guru.email}</td>
                      <td className="px-5 py-3.5 text-[12.5px] text-[#5b657d]">
                        {formatterTanggal.format(new Date(guru.createdAt))}
                      </td>
                      <td className="px-5 py-3.5 text-[12.5px] text-[#5b657d]">{guru._count.ujianDibuat} ujian</td>
                      <td className="px-5 py-3.5">
