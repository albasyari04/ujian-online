...
export const metadata: Metadata = {
  title: "Daftar - Ujian Online",
  description: "Buat akun peserta untuk mulai mengikuti ujian online.",
}

/* =========================================================
   FEATURES — sama persis dengan yang dipakai di page login
========================================================= */
...
/* =========================================================
   REGISTER PAGE
   Struktur JSX 1:1 dengan page.tsx (login) — hanya heading,
   deskripsi, dan komponen form (RegisterForm) yang berbeda.
========================================================= */
...
export default async function RegisterPage() {
  ...
  if (session?.user?.role === "ADMIN" || session?.user?.role === "PESERTA") {
    redirect(session.user.role === "ADMIN" ? "/dashboard" : "/beranda-peserta")
  }
  ...
  return (
    ...
    >
      {/* ===================================================
          DEKORASI LATAR — identik dengan page login
      =================================================== */}
      <div
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1360px] flex-col items-center gap-6 px-5 py-6 lg:h-full lg:flex-row lg:items-center lg:justify-between lg:gap-8 lg:px-10 lg:py-4 xl:px-16">
        ...
        <section className="hidden h-full w-full max-w-[620px] flex-col lg:flex">
          ...
          {/* Blok teks — tinggi tetap, selalu tampil penuh */}
          <div className="shrink-0">
            ...
            >
              Daftar Akun,
              <br />
              Mulai Belajar di <span className="text-[#2f5fd8]">Ujian Online</span>
            </h1>

            <p className="relative z-10 mt-2.5 max-w-[500px] text-[13.5px] leading-relaxed text-[#3d4a63]">
              Buat akun peserta untuk mengikuti ujian dengan aman, mudah, dan hasil yang bisa dipantau kapan saja.
            </p>
        ...
        {/* ===================================================
            MOBILE ONLY — atas: ilustrasi polos + heading singkat
        =================================================== */}
        <div className="flex w-full flex-col items-center gap-4 pt-2 lg:hidden">
          ...
          <div className="text-center">
            <h1
              ...
              style={{ fontFamily: "var(--font-display)" }}
            >
              Daftar Akun di <span className="text-[#2f5fd8]">Ujian Online</span>
            </h1>
            <p className="mx-auto mt-1.5 max-w-[320px] text-[12.5px] leading-relaxed text-[#5b6a86]">
              Buat akun peserta untuk mulai mengikuti ujian.
            </p>
          </div>
        </div>

        {/* ===================================================
            RIGHT — kartu register mengambang
        =================================================== */}
        ...
        {/* ===================================================
            MOBILE ONLY — bawah: fitur ditaruh setelah card register
        =================================================== */}
