    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full resize-none rounded-[10px] border border-[#e7e4dc] bg-white px-3.5 py-2.5 text-[14px] text-[#16233f] outline-none transition-colors focus:border-[#818cf8] focus:ring-2 focus:ring-[#eef2ff] dark:border-white/10 dark:bg-white/5 dark:text-white dark:focus:border-[#818cf8] dark:focus:ring-[#4338ca]/20"
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <select
            ...
            className="w-full rounded-[10px] border border-[#e7e4dc] bg-white px-3.5 py-2.5 text-[14px] text-[#16233f] outline-none transition-colors focus:border-[#818cf8] focus:ring-2 focus:ring-[#eef2ff] dark:border-white/10 dark:bg-white/5 dark:text-white dark:focus:border-[#818cf8] dark:focus:ring-[#4338ca]/20"
          >
        ...
        <div>
          ...
          <div className="space-y-2.5">
            {opsi.map((o, idx) => (
              <div
                key={o.key}
                className="flex items-center gap-2.5 rounded-[10px] border border-[#e7e4dc] bg-white p-2 dark:border-white/10 dark:bg-white/5"
              >
                <input
                  type="radio"
                  name="jawaban-benar"
                ...
                />
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#eef2ff] text-[11px] font-bold text-[#4338ca] dark:bg-[#4338ca]/20 dark:text-[#818cf8]">
                ...
                <input
                  ...
                  required
                  className="w-full bg-transparent text-[13.5px] text-[#16233f] outline-none placeholder:text-[#94a3b8] dark:text-white"
                />
                {opsi.length > 2 && (
                  <button
                    type="button"
                    onClick={() => hapusOpsi(o.key)}
                    className="shrink-0 rounded-full p-1.5 text-[#d23b3b] hover:bg-[#fdf1f1] dark:hover:bg-red-500/10"
      ...
      {/* Aksi */}
      <div className="flex items-center gap-3 border-t border-[#edf0ef] pt-5 dark:border-white/10">
        <button
          type="submit"
          disabled={loading}
        ...
        >
          {loading ? "Menyimpan..." : mode === "create" ? "Simpan Soal" : "Simpan Perubahan"}
        </button>
        <button
          type="button"
